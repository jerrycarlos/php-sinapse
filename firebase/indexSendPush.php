<html>
    ...
    <body>
        ...
        require_once '../firebaseAdmin/firebase.php';
        require_once '../firebaseAdmin/pushNotification.php';
        ...
        if ($push_type == 'multiple') {
            $json = $push->getPush();
            $response = $firebase->sendMultiple($json);
        ...
        <div class="container">
            ...
            <form class="pure-form pure-form-stacked" method="get">
                <fieldset>
                    <legend>Send to multiple devices</legend>
                    ...
                    <input type="hidden" name="push_type" value="multiple"/>
